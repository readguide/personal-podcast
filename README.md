...
```bash
mkdir -p "/Users/en/Downloads/en/Personal Podcast/Repository"
git clone https://github.com/readguide/personal-podcast.git \
  "/Users/en/Downloads/en/Personal Podcast/Repository/personal-podcast"
cd "/Users/en/Downloads/en/Personal Podcast/Repository/personal-podcast"
...
```text
/Users/en/Downloads/en/Personal Podcast/Application Data/config.toml
```
...
```text
/Users/en/Downloads/en/Personal Podcast/
├── Application Data/
│   ├── config.toml
│   ├── podcast.db
│   └── logs/
